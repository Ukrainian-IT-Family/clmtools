            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body notification-modal-body" v-if="notificationsExist">
                        <button type="button" @click="deleteNotifications">Видалити всі</button>
                        <div
                        ...
                        >
                            ...
                            <div class="toast-body">
                                ...
                                <a v-if="notification.id > 0" @click="deleteNotification(notification.id, notification.url)">Перейти</a>
                            </div>
                        </div>
                    </div>
